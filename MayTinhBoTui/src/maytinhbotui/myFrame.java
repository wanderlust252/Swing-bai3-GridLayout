...
public class myFrame extends JFrame {
    ...
    private String[] but1;
    private ImagePanel panel = new ImagePanel(new ImageIcon("background.png").getImage());
    ...
    private void giaodien() {
       // panel.setSize(400,400);
        ...
        panelbg = new Panel();
        panelbg.add(panel,BorderLayout.SOUTH);
        ...
        panelbg.add(panelnumber,BorderLayout.CENTER);
        
        this.add(panelOut1, BorderLayout.NORTH);
        this.add(panelbg, BorderLayout.SOUTH);
        panelnumber.setPreferredSize(new Dimension(0, 400));
    }

    private void xuly() {
//        arr.get(8).addActionListener(new ActionListener() {
//            @Override
...
//            }
//        });
//        arr.get(9).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "2";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(10).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "3";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(4).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "4";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(5).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "5";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(6).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "6";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(0).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "7";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(1).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "8";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(2).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "9";
//                lblOUT.setText(num);
//            }
//        });
//        arr.get(13).addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                num += "0";
//                lblOUT.setText(num);
//            }
//        });
        // gói gọn đống trên này bằng vòng for dưới đây
        for (int i = 0; i < 10; i++) {
